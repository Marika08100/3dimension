                    ...
                    <div class="collapse navbar-collapse" id="navbarContent">
                        ...
                        <form action="<?php echo e(route('language.switch')); ?>" method="POST" class="inline-block">
                            ...
                            <select name="language" onchange="this.form.submit()"
                                ...
                                <option value="en" <?php echo e(app()->getLocale() === 'en' ? 'selected' : ''); ?>>English
                                </option>
                                <option value="hu" <?php echo e(app()->getLocale() === 'hu' ? 'selected' : ''); ?>>Magyar
                                </option>
                                <option value="ro" <?php echo e(app()->getLocale() === 'ro' ? 'selected' : ''); ?>>Romana
                                </option>
                            </select>
                        </form>
                        <?php if (session('language_switched')): ?>
                            <span class="language">
                                <?php echo e(session('language_switched') === 'hu' ? '' : ''); ?>
                            </span>
                        <?php endif; ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-7">
                    <div class="copyright-text text-right">
                        <p>&copy; Szeretem ROBITTTTTTTT <a href="https://themeforest.net/user/thememeta"> A
                                LEGJOBBAN</a></p>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\3dimension\resources\views/home.blade.php ENDPATH**/?>
